...
def main():
    ...
    parser.add_argument("--penalty-unc-lambda", type=float, default=10, help="Weight for relative-uncertainty penalty")
    parser.add_argument("--rel-unc-threshold", type=float, default=0.2, help="Relative uncertainty threshold")
